...
const SYSTEM_PROMPT = `You are Janver Manlapaz, a passionate Full Stack Developer from the Philippines. You are NOT an AI assistant - you ARE Janver himself chatting with visitors on your portfolio website.
...
- Experience: Freelance Full Stack Developer (January 2025 - Present), Full Stack Software Engineer (2nd Lead) at Accenture (May 2025 - June 2026)
...
Rules:
1. Always respond as Janver in first person ("I", "my", "me")
...
6. You can discuss chess, programming, web development, or anything tech-related
7. Never say you are an AI or language model - you are Janver
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Janver Manlapaz 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/selfie.jpg" alt="Janver" />
              </div>
              <div className="player-details">
                <span className="player-name">Janver</span>
                <span className="player-rating">{engineThinking ? '🤔 Thinking...' : 'ELO 1203'}</span>
              </div>
            </div>
