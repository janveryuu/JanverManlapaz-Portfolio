...
const techStack: TechItem[][] = [
  ...
  [
    ...
    { name: "Render", icon: "https://cdn.simpleicons.org/render/white", url: "https://render.com" },
  ],
  // Row 5 - 2 items (tip of pyramid)
  [
    { name: "Three.js", icon: "https://cdn.simpleicons.org/threedotjs/white", url: "https://threejs.org" },
    { name: "GSAP", icon: "https://cdn.simpleicons.org/greensock/white", url: "https://gsap.com" },
  ],
];
